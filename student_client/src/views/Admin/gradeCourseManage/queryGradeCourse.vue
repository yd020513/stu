      ...
      <el-main>
        <el-card>
          <el-form :inline="true" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
            ...
            <el-form-item label="查询" prop="sFuzzy">
            ...
            <el-form-item label="查询" prop="tFuzzy">
            ...
            <el-form-item label="查询" prop="cFuzzy">
...
export default {
  ...
  created() {
    const that = this
    axios.get('http://localhost:8888/SCT/findAllTerm').then(function (resp) {
