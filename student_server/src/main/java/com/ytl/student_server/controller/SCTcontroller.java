...
import com.ytl.student_server.entity.CourseTeacherInfo;
import com.ytl.student_server.entity.SCTInfo;
import com.ytl.student_server.entity.StudentCourseTeacher;
import com.ytl.student_server.service.SCTService;
...
public class SCTcontroller {
    ...
    public String save(@RequestBody StudentCourseTeacher studentCourseTeacher) {
        ...
        return sctService.save(studentCourseTeacher) ? "选课成功" : "选课失败，请联系管理员";
    }
